...
def main():
    ...
    try:
        driver.get("https://macht.test.edu/grafana/login/")
        driver.find_element_by_name("username").click()
        driver.find_element_by_name("username").clear()
        driver.find_element_by_name("username").send_keys("macht")
        ...
        driver.find_element_by_xpath(xpath).click()
        prefix = "https://macht.test.edu/grafana/dashboard/snapshot/"
    ...
    try:
        ...
        add_snap_cmd = ("INSERT INTO macht_grafanasnapshot "
                        "(url, created_on) VALUES (%s, %s)")
        cur.execute(add_snap_cmd, (snapshot_url, time))
        del_old_snap_cmd = "DELETE FROM macht_grafanasnapshot WHERE (url) != (%s)"
