...
def run_ttp(ttp_path, yaml_settings_path):
    ...
    for expt in yaml_settings['experiments']:
        ...
        gs_url = 'gs://macht-models/macht-ttp/{}'.format(tar_file)
    ...
    for expt in yaml_settings['experiments']:
        ...
        # share the new model among all abr_name containing 'macht_ttp_cl'
        if ('abr_name' not in fingerprint or
            'macht_ttp_cl' not in fingerprint['abr_name']):
            continue
