...
macht::macht(const WebSocketClient & client,
...
void macht::video_chunk_acked(Chunk && c)
{
...
VideoFormat macht::select_video_format()
{
  reinit();
...
void macht::deal_all_ban(size_t i)
{
  double min_v = 0;
...
size_t macht::update_value(size_t i, size_t curr_buffer, size_t curr_format)
{
...
double macht::get_qvalue(size_t i, size_t curr_buffer, size_t curr_format,
                          size_t next_format)
{
...
double macht::get_value(size_t i, size_t curr_buffer, size_t curr_format)
{
...
size_t macht::discretize_buffer(double buf)
{
