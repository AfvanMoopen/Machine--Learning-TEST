...
macht_BASE_DIR = os.path.dirname(os.path.dirname(BASE_DIR));

# Default path of macht's YAML configuration file
yaml_config_path = os.path.join(macht_BASE_DIR, 'src', 'settings.yml')
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'macht', 'static')
