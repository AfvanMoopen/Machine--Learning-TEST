...
def index(request):
    return render(request, 'macht/index.html')


def faq(request):
    return render(request, 'macht/faq.html')


def terms(request):
    return render(request, 'macht/terms.html')


def data_description(request):
    return render(request, 'macht/data-description.html')

def bola(request):
    return render(request, 'macht/bola.html')


def results(request, input_date=''):
    context = {'input_date': input_date}
    return render(request, 'macht/results.html', context)
...
def player(request):
    ...
    return render(request, 'macht/player.html', context)
...
def monitoring(request):
    ...
    if not snapshot:
        return render(request, 'macht/404.html')
    ...
    return render(request, 'macht/monitoring.html', context)


@login_required(login_url='/accounts/login/')
def profile(request):
    if request.method != 'POST':
        return render(request, 'macht/profile.html')
...
def rating(request):
    if request.method != 'POST':
        ...
        return render(request, 'macht/rating.html', context)
...
def participate(request):
    if request.method != 'POST':
        return render(request, 'macht/participate.html')
