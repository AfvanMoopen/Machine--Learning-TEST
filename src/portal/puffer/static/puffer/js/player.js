...
function ControlBar() {
  ...
  const volume_on_img = 'url(/static/macht/dist/images/volume-on.svg)';
  const volume_off_img = 'url(/static/macht/dist/images/volume-off.svg)';
  ...
  const enter_fullscreen_img = 'url(/static/macht/dist/images/enter-fullscreen.svg)';
  const exit_fullscreen_img = 'url(/static/macht/dist/images/exit-fullscreen.svg)';
...
function init_player(params_json, csrf_token) {
  ...
  load_script('/static/macht/js/macht.js').onload = function() {
