...
function AVSource(ws_client, server_init) {
  ...
  if (window.MediaSource) {
    ...
    set_fatal_error(
      ...
      'which macht requires to stream media. Please refer to the FAQ and ' +
      'try another browser or device on which macht is supported.'
    );
  ...
  function init_source_buffers() {
    ...
    try {
      ...
      set_fatal_error(
        ...
        'Opus in WebM, used by macht. Please refer to the FAQ and ' +
        'try another browser or device on which macht is supported.'
      );
