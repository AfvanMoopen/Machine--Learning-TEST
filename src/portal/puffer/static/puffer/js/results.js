...
const gs_storage_prefix = 'https://storage.googleapis.com/macht-data-release/';
const gs_console_prefix = 'https://console.cloud.google.com/storage/browser/macht-data-release/';
...
function change_date() {
  ...
  var model_path = 'https://storage.googleapis.com/macht-models/macht-ttp/bbr-' +
                   model_date + '-1.tar.gz';
